...
import { ReportEmployeeMasterComponent } from './report-employee-master/report-employee-master.component';
    ...
    const routes: Routes = [
       ...
       { path: 'report-employee-master', component: ReportEmployeeMasterComponent },
    ];
